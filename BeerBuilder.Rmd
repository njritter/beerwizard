...
```{r}
index <- 1
beer <- read_html(paste("/Users/Drazi/beerwizard/data/test_profiles/profile_", index, sep = ""))
...
beerInfo <- data.frame(name = NA,
                       brewery = NA,
                       rating = 1:10) # makes data frame have 10 rows
                       
for(i in 1:10){
  beer <- read_html(
    paste("/Users/Drazi/beerwizard/data/test_profiles/profile_", i, sep = ""))
...
write.csv(beerInfo,
          file = "/Users/Drazi/beerwizard/data/test_profiles/test_beer_info.txt")
