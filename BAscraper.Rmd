...
read_html("https://www.beeradvocate.com/lists/top/")
...
```{r}
# all beer names
names <- html_nodes(x, ".hr_bottom_light a b")
...
all_links <- html_attr(html_nodes(x, "a"), "href")
...
html_nodes(beer, "br+ .muted")

```

```{r}
# Get text of up to first 25 user reviews
